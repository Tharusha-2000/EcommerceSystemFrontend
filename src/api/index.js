...
export const updateProduct = async (id, productData) =>{
  ...
  return await API2.put(`Product/UpdateProductAsync/${id}`, productData,config);
}
...
export const addToCart = async ( data) =>{ 
  ...
  return await API3.post(`Cart/`, data,config);
}
...
export const GetFeedbackByOrderId = async (orderId) => {
  ...
  const response = await API4.get(`/FeedBack/GetFeedbackByOrderId/${orderId}`,config);
  return response;
};
